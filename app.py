...
# Total employers: count distinct non-Unknown employers from enrolled list
# (enrolled HCCs reliably have employerName; preEnrollment may not)
if not df_enrolled.empty:
    total_employers = df_enrolled[df_enrolled["employerName"] != "Unknown"]["employerName"].nunique()
else:
    total_employers = 0
